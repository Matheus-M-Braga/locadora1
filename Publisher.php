...
$result = mysqli_query($conexao, "SELECT * FROM editoras");
?>
<!DOCTYPE html>
<html lang="pt-br">
        ...
        <nav class="menubar">
            ...
            <div class="links">
                ...
                <div class="link">
                    ...
                    <a href="Publisher.php" class="selected">Editoras</a>
                </div>
                <div class="link">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-content" id="dropdownContent">
                    ...
                    <li><a href="Publisher.php" class="selected" id="pageTitle">Editoras</a></li>
