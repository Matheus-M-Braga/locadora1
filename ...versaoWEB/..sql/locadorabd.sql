...
VALUES
  (
    ...
    'J.B. Lippincott & Co.',
    'Filadélfia',
    'info@jblippincott.com'
  ),
  (
    2,
    'Secker & Warburg',
    'Londres',
    'info@seckerwarburg.com'
  ),
  (
    3,
    'T. Egerton, Whitehall',
    'Londres',
    'info@tegertonwhitehall.com'
  ),
  (
    4,
  ...
  (
    ...
    'Harper & Brothers',
    'Nova Iorque',
    'info@harperbrothers.com'
  ),
  (
    6,
    'Little, Brown and Company',
    'Boston',
    'info@littlebrown.com'
  ),
  (
    7,
    'Harper & Row',
